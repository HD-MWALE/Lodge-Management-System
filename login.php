...
<div id="login">
    <div class="container">
        <div class="section-header">
            <h2>Login</h2>
            <div class="button"><a href="index.php?page=register">Don't have an account.</a></button></div>
        </div>
            ...
            <div class="col-md-6">
                <div class="login-form" style="width: 400px; margin-left: auto; margin-right: auto;">
                    <form id="login-form" method="POST">
                        ...
                        <div class="button"><button style="width: 400px;" name="forgot" type="submit">Forgot password.</button></div>
                    </form>
                </div>
            </div>
        </div>
...
if(isset($_POST['login'])){
    ...
    if($stmt->execute()){
        ...
        if($stmt->num_rows == 1){      
            ...
            echo "<script>alert('Please fill in the log in details.');</script>";
        }
    }else{
...
if(isset($_POST['forgot'])){
    echo "<script>
            setTimeout(function(){
                location.replace('index.php?page=forgot-password')
            },750)
        </script>";
}
?>