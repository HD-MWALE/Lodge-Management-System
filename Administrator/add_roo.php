...
<div class="col-lg-12">
	<div class="card" style="border-top: 3px solid rgb(14, 111, 255);">
		<div class="card-body">
            ...
            <input type="hidden" name="id" value="<?php echo isset($room_id) ? $room_id : '' ?>">
				<?php 
				$selected_id = '';
				if(isset($room_id)){
                    $selected_id = 1;
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-danger" type="button" onclick="location.href = 'index.php?page=room_details'">Cancel</button>
				</div>
			</form>
		</div>
	</div>
