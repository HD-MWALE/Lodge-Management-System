            ...
            <div class="table-responsive" id="printable">
              <table class="table m-0 table-bordered">
                ...
                <tbody>
					...
					$query = "SELECT `room_id`, `room_name`, `room_type`, `status`, `date_created`, `date_updated`, `staff_id` FROM `room` WHERE `frequncy` >= 2 ORDER BY `room_id` ASC";
...
<script>
	$('#print').click(function(){
		...
		var _d = "<p class='text-center'><b>Frequently Used Rooms Report as of (<?php echo date("F d, Y") ?>)</b></p>"
		_p.prepend(_d)
		_p.prepend(_h)
