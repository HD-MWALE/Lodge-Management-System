    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 img-cols">
                <div class="img-col">
                    <img class="img-fluid" src="./assets/img/about/about-1.jpg">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 img-cols d-block d-md-none">
                <div class="img-col">
                    <img class="img-fluid" src="./assets/img/about/about-2.jpg">
                </div>
            </div>
            <div class="col-md-6 content-cols">
                <div class="content-col">
        ...
        <div class="row">
            <div class="col-md-6 img-cols">
                <div class="img-col">
                    <img class="img-fluid" src="./assets/img/about/about-3.jpg">
                </div>
            </div>
            <div class="col-md-6 content-cols">
                <div class="content-col">
